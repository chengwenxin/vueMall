import Vue from 'vue'
import Header from './cwxHeader'
import Footer from './cwxFooter'
import SlideContent from './cwxSlideContent'
import SlideContentItem from './cwxSlideContentItem'
...
Vue.component('cwx-slide-content-item',SlideContentItem)
